...
public class Application {
    public static void main(String[] args) {
        ...
        DeveloperService developerService = new DeveloperService(developerRepository, companyRepository, developerShortConverter, developerConverter, developerProjectConverter);
